...
public class String01 {
	...
	public static void main(String[] args) {
		 ...
		 * 그중 가장 많이 사용하는 method가 바로 문자열변수의 값을 비교하는 equals() method이다
		 * 
		 * equals()
		 * 문자열형 변수의 저장된 실제 문자열이 같은가를 비교하는 method()이다
		...
		System.out.println("Korea".equalsIgnoreCase("KOREA"));  // true 대문자여도 true
		System.out.println("Korea".equalsIgnoreCase("KOREA")); // true                         id:Ignore pw:equals

...
public class Number_Ex {
	...
	public static void main(String[] args) {
		...
		// Integer.valueOf() : 숫자형 문자열을 정수로 변환 시키는 method
		Integer.valueOf("34"); // 정수 34
		Float.valueOf("34.3"); // 자바1.5이후생김
		Double.valueOf("34.3");
		Long.valueOf("3333333");
		
		Integer.parseInt("34");  // 자바1.5 이전에만들어진메서드
		Float.parseFloat("34.3"); // 안쓴다.

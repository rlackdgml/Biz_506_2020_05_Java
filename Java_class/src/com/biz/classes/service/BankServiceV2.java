...
/*
 * main method 가 없는 class 직접 rum을 수행 할수 없다.
 * main method 가 있는 코드에서
 * 클래스를 인스턴스로 선언하고 인스턴스를 통해서 method를 호출해서
 * 사용해야한다
 */
public class BankServiceV2 {
	/*
	 * method() 어떤코드들의 묶음을 만들어두고 사용할떄 한, 두줄의 명령문만으로 기능을 수행하고자 할때 작성하는 코드
	 */
	...
	/*
	 * bankVO 크래스로 생성한 인스턴스에 담긴 데이터들을 매개변수로 받아서 무언가 처리를 하는 method
	 */

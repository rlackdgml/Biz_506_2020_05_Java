 ...
 * add unimplements method를 실행하여야 한다.
 */
...
public class BookServiceImplV1 implements BookService {
	...
	public boolean inputBook() {
		...
		// 필드변수에 선언하지 않고 method 의 지역변수로 선언, 초기화를 수행
		...
		try {
			 ...
			 * 현재 입력하고 있는 도서정보를 도서명부터 다시입력하도록
			 */
		

			System.out.println("출판연도는 숫자만 가능!!");
			System.out.println(bookVO.getTitle() + "도서정보부터 다시 입력 하세요");
		...
		try {
			...
			System.out.println(bookVO.getTitle() + "도서 정보부터 다시 입력 하세여");
		 ...
		 * 호출하게 될 것이고
		 * 
		 * return 하기전에 현재 도서를 다시 입력하라는 메시지를
		 * 보여주었으므로 
